...
public class PruebasLambdas {
	...
	public static void main(String[] args) {
		...
		-Consumer: Interfaz funcional unica que acepta un prametro y que se invoca por medio del metodo unico accept
		-Predicate: Interfaz funcional unica que evalua una condicion dada para retornar un boolean por medio del metodo test
		-Function: Interfaz funcional unica que acepta una entrada y una salida a la cual le aplicara una trasnformacion/operacion por medio de apply
		-Supplier: Interfaz funcional unica que sirve como generador de semilla o dato por medio de get
		 */
